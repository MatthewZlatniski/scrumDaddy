...
describe('Test Sprint specific 1', () => {
  let connection;
  ...
  it('makes sure a user story is assigned the correct sprint', (done) => {
...
describe('Test sprint specific 2', () => {
  let connection;
  ...
  it('when moved to the next sprint, it makes sure the next sprint tasks are loaded', (done) => {
    // Define the project data to be inserted
    const projectData = {
        loggedhours: 3,
...
describe('Test sprint specific 3', () => {
    let connection;
    ...
    it('when moved to the next sprint, it ensures incomplete tasks carry over', (done) => {
      // Define the project data to be inserted
      const projectData = {
          loggedhours: 3,
          taskprojectuserlistID: 58,
