...
describe('Peer review test 1', () => {
  ...
  it('when moved to the next sprint, all users on project get a peer review form to fill out', (done) => {
...
describe('Peer review test 2', () => {
  ...
  it('when everyone has completed the review except one, and that person leaves the project an email of all the scores is sent', (done) => {
    // Define the project data to be inserted
    const projectData = {
        loggedhours: 3,
...
describe('Peer review test 3', () => {
    ...
    it('ensures email is sent to product owner', (done) => {
      // Define the project data to be inserted
      const projectData = {
          loggedhours: 3,
          taskprojectuserlistID: 58,
