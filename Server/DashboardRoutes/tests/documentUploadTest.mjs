...
describe('Document Upload Test 1', () => {
    let connection;
    ...
    it('Template documents are in the database', (done) => {
...
describe('Document Upload Test 2', () => {
  let connection;
  ...
  it('Documents should be in database after uploading', (done) => {
    // Define the project data to be inserted
    const projectData = {
      projectName: 'Test 2',
